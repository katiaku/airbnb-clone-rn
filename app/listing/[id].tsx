...
const Page = () => {
  ...
  // if (!listing) {
  //   console.error(`Listing no encontrado para ID: ${numericId}`);
  //   return (
  //     <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
  //       <Text>La propiedad solicitada no existe o no está disponible.</Text>
  //     </View>
  //   );
  // }
    ...
    <View>
      ...
      >
        ...
        <View style={styles.infoContainer}>
          ...
          <Text style={styles.rooms}>Room type: {listing.room_type}</Text>
          ...
          <View style={styles.hostView}>
            ...
            <View>
              ...
              <Text>Last review: {listing.last_review}</Text>
            </View>
          </View>
          ...
          <Text style={styles.description}>
            Availability: {listing.availability_365} days
          </Text>
        </View>
      </Animated.ScrollView>
      ...
      >
        ...
        >
          <TouchableOpacity style={styles.footerText}>
            <Text style={styles.footerPrice}>€{listing.column_10}</Text>
            <Text>night</Text>
          </TouchableOpacity>
